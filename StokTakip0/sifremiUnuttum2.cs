...
namespace StokTakip0
{
    public partial class sifremiUnuttum2 : Form
    {
        ...
        private void sifremiUnuttum2_Load(object sender, EventArgs e)
        {
        ...
        private void btnSifreAl_Click(object sender, EventArgs e)
        {
                ...
                {
                    baglanti.Open();
                    string sorgu = "Select personelSifre From personel where personelEposta=@user and personelTC=@tc";
